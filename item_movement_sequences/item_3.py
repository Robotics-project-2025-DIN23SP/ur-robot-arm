...
def get_sequence(gr):
    return [
        ...
        (4, "Move to Position (Grasp)", lambda: move_to("position_grasp_item_3", 5, "movel")),
        ...
        (7, "Move to GoPiGo High Position", lambda: move_to("position_gopigo_high", 5)),
        (8, "Move to GoPiGo Low Position", lambda: move_to("position_gopigo_low", 5, "movel")),
