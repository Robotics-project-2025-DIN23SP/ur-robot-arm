...
POSITION_GOPIGO_LOW: List[float] =  degrees_to_radians([-1.81, -67.92, 86.50, -110.30, -91.32, -182.13])
POSITION_GOPIGO_HIGH: List[float] =  degrees_to_radians([-1.81, -53.90, 102.28, -140.11, -91.30, -182.15])
