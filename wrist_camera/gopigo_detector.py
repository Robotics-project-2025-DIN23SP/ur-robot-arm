...
ref_imgs = [
    cv2.imread(os.path.join(REF_IMG_DIR, "gopigo_image_5.jpeg"), cv2.IMREAD_GRAYSCALE),
    cv2.imread(os.path.join(REF_IMG_DIR, "gopigo_image_6.jpeg"), cv2.IMREAD_GRAYSCALE),
]
